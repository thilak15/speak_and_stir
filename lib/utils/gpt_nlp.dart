...
class GPTNLP {
  ...
  Future<List<Recipe>> generateRecipes(String query ,{int count =1}) async {
    ...
    String prompt =
        "Generate a list of $count recipes with their title, origin, type, preparation time, cooking time, ingredients, and steps separated by commas in the following format: 'Title | Origin | Type | Preparation Time | Cooking Time | Ingredients | Steps' based on the following query: $query";
